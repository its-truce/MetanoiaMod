...
namespace Metanoia.Projectiles
{
    public class MjolnirHammer : ModProjectile
    {
        ...
        public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
        {
            ...
            if (lightningCount == 1)
            {
                Projectile.NewProjectile(Projectile.GetSource_FromThis(), target.Center + new Vector2(0, -900), new Vector2(0f, 25f), ModContent.ProjectileType<LightningStrike>(), 230, 0, Projectile.owner);
                lightningCount = 0;
            }
        }
    }
