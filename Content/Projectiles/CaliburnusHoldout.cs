...
namespace Metanoia.Projectiles
{
    public class CaliburnusHoldout : ModProjectile
    {
        ...
        public override string Texture => "Metanoia/Items/Caliburnus";
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Texture2D trail = (Texture2D)ModContent.Request<Texture2D>("Metanoia/Projectiles/CaliburnusHoldoutTrail", (AssetRequestMode)2);
            Texture2D glowMask = (Texture2D)ModContent.Request<Texture2D>("Metanoia/Projectiles/CaliburnusGlowmask", (AssetRequestMode)2);
            Texture2D glowMaskWhite = (Texture2D)ModContent.Request<Texture2D>("Metanoia/Projectiles/CaliburnusGlowmaskWhite", (AssetRequestMode)2);
            ...
            for (int j = 0; j < Projectile.oldPos.Length; j++)
            {
                ...
                Color colorAfterEffect = Projectile.GetAlpha(Color.Lerp(new Color(247, 188, 77, 100), new Color(248, 151, 76, 200), Projectile.ai[0] / 70f)) * ((float)(Projectile.oldPos.Length - j) / (float)Projectile.oldPos.Length) * 0.5f;
            ...
            for (int i = 0; i < 5; i++)
            {
                Main.spriteBatch.Draw(glowMaskWhite, drawPos, null, Color.Lerp(new Color(247, 188, 77, 100), new Color(248, 151, 76, 200), Projectile.ai[0] / 70f) * 0.05f, Projectile.rotation, drawOrigin, Projectile.scale + 0.1f * (float)i, effects, 0f);
            }
