...
namespace Metanoia.Content.Projectiles
{
    ...
    {
        public override string GlowTexture => "Metanoia/Content/Projectiles/SlashWhite";
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            ParticleOrchestrator.RequestParticleSpawn(clientOnly: false, ParticleOrchestraType.NightsEdge, settings);
        }
    }
}