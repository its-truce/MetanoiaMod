...
namespace Metanoia.Content.Projectiles
{
    ...
    public class ApolloBeam : ModProjectile
    {
        ...
        private void ChargeLaser(Player player)
        {
            ...
            else
            {
                ...
                for (int k = 0; k < chargeFact + 1; k++)
                {
                    ...
                    Dust dust = Main.dust[Dust.NewDust(pos, 20, 20, DustID.Firework_Yellow, Projectile.velocity.X / 2f, Projectile.velocity.Y / 2f)];
